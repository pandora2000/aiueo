...
L_sin_2448 : 
	...
	fload	f6 r0 36
	fload	f7 r0 54
	fbgt	f2 f7 L_else_8286
	fload	f3 r0 35
	fbgt	f3 f2 L_else_8287
	jump	L_psin_2444
L_else_8287 : 
	fload	f3 r0 34
	fbgt	f3 f2 L_else_8288
	fadd	f2 f4 f2
	addi	r2 r2 1
	call	L_pcos_2446
	subi	r2 r2 1
...
L_cos_2450 : 
	...
	fload	f6 r0 36
	fload	f7 r0 54
	fbgt	f2 f7 L_else_8291
	fload	f3 r0 35
	fbgt	f3 f2 L_else_8292
	jump	L_pcos_2446
L_else_8292 : 
	fload	f3 r0 34
	fbgt	f3 f2 L_else_8293
	fadd	f2 f2 f4
	jump	L_psin_2444
L_else_8293 : 
	fadd	f2 f6 f2
	...
	return
L_else_8291 : 
	fbgt	f2 f3 L_else_8294
	jump	L_pcos_2446
L_else_8294 : 
	fbgt	f2 f5 L_else_8295
	fsub	f2 f2 f4
	addi	r2 r2 1
	call	L_psin_2444
	subi	r2 r2 1
...
L_xor_2460 : 
	addi	r6 r0 0
	bne	r4 r6 L_else_8297
	add	r4 r0 r5
	return
L_else_8297 : 
	addi	r4 r0 0
	bne	r5 r4 L_else_8298
	addi	r4 r0 1
	return
L_else_8298 : 
	addi	r4 r0 0
...
L_else_8327 : 
	addi	r5 r0 2
	bne	r8 r5 L_else_8338
	addi	r5 r0 0
	load	r8 r2 13
	bne	r8 r5 L_else_8340
	addi	r5 r0 1
	jump	L_cont_8341
L_else_8340 : 
	addi	r5 r0 0
...
L_utexture_2786 : 
	...
	addi	r7 r0 0
	load	r8 r2 12
	bne	r8 r7 L_else_8545
	addi	r7 r0 0
	bne	r4 r7 L_else_8547
	fload	f2 r0 12
	jump	L_cont_8548
L_else_8547 : 
	fload	f2 r0 54
...
L_neighbors_exist_2832 : 
	...
	addi	r7 r0 1
	add	r7 r5 r7
	bgt	r6 r7 L_else_8628
	addi	r4 r0 0
	return
L_else_8628 : 
	addi	r6 r0 0
	bgt	r5 r6 L_else_8629
	addi	r4 r0 0
	return
L_else_8629 : 
	addi	r5 r0 4130
	...
	addi	r6 r0 1
	add	r6 r4 r6
	bgt	r5 r6 L_else_8630
	addi	r4 r0 0
	return
L_else_8630 : 
	addi	r5 r0 0
	bgt	r4 r5 L_else_8631
	addi	r4 r0 0
	return
L_else_8631 : 
	addi	r4 r0 1
...
L_write_rgb_element_2854 : 
	fload	f3 r0 12
	fbgt	f2 f3 L_else_8643
	fload	f3 r0 54
	fbgt	f3 f2 L_else_8645
	fadd	f2 f0 f2
	jump	L_cont_8646
L_else_8645 : 
	fload	f2 r0 54
...
L_else_8689 : 
	...
	subi	r2 r2 3
	addi	r5 r0 1
	bne	r4 r5 L_else_8691
	load	r4 r2 0
	load	r5 r2 1
	jump	L_setup_rect_reflection_2936
L_else_8691 : 
	addi	r5 r0 2
	bne	r4 r5 L_else_8692
	load	r4 r2 0
	load	r5 r2 1
